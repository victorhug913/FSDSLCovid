...
require('data.table')
fwrite(DescCat, file ="Saida/DescCat_Menores_60.csv")
RegBru$Variavel <- rownames(RegBru)
fwrite(RegBru, file ="Saida/RegBru_Menores_60.csv")
fwrite(AssocCat, file ="Saida/AssocCat_Menores_60.csv")
write.csv(ajuste1, file="Saida/ajuste1_Mariores_60.csv")
write.csv(ajuste2, file="Saida/ajuste_Menores_60.csv")