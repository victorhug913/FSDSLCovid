...
require('data.table')
fwrite(DescCat, file ="Saida/DescCat_Total.csv")
RegBru$Variavel <- rownames(RegBru)
fwrite(RegBru, file ="Saida/RegBru_Total.csv")
fwrite(AssocCat, file ="Saida/AssocCat_Total.csv")
write.csv(ajuste1, file="Saida/ajuste1_Total.csv")
write.csv(ajuste2, file="Saida/ajuste2_Total.csv")